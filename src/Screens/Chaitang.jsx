...
const Chaitang = () => {
    ...
    const Chai = [
        {
            id: '1',
            image: require('../assets/images/Chai tang.jpg'),
            title: 'Ketucky Fried\nChicken',
            price: '#6,000'
        },
        {
            id: '2',
            image: require('../assets/images/Chai tang1.jpg'),
            title: 'Crispy Fry\nChicken',
            price: '#8,000'
        },
        {
            id: '3',
            image: require('../assets/images/Chai tang2.jpg'),
            title: 'Southern\nFried Chicken',
            price: '#4,000'
        },
        {
            id: '4',
            image: require('../assets/images/Chai tang3.jpg'),
            title: 'Dynamic Fried\nChicken Wings',
            price: '#5,000'
        },
        {
            id: '5',
            image: require('../assets/images/Chai tang4.jpg'),
    ...
    const food = ({ item }) => (
        ...
        <View style={styles.step3}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Chaipurchase', { image: item.image, title: item.title, price: item.price })} activeOpacity={0.7} style={styles.step4}>
